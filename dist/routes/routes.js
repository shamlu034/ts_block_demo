...
function RegisterRoutes(app) {
    ...
    app.get('/users', ...((0, runtime_1.fetchMiddlewares)(user_1.UserController)), ...((0, runtime_1.fetchMiddlewares)(user_1.UserController.prototype.getUser)), function UserController_getUser(request, response, next) {
